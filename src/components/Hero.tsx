...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative pt-24 pb-20 md:pt-32 md:pb-24 bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div className="flex flex-col lg:flex-row items-center">
          ...
          <div className="lg:w-1/2 relative">
            <div className="relative rounded-xl overflow-hidden shadow-2xl">
              <img 
                src="https://images.pexels.com/photos/7639360/pexels-photo-7639360.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" 
                alt="Inventory Audit" 
